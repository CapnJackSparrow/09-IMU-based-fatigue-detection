...
# Declare the path for the class file
script_dir = os.path.dirname(os.path.abspath(__file__))

# Create the main directory path by joining the class file path to the path of
# the parent directory (where the data folder is located)
root_dir = os.path.abspath(os.path.join(script_dir, '09-IMU-based-fatigue-detection/', '..'))
...
class DataLoader:
    ...
    def data_summary(self):
        ...
        # Join the data folder path to that of the main directory
        ...
        try:
            ...
            df = pd.read_excel(f"{file_path}/general_info.xlsx",
                               engine = "openpyxl",
                               sheet_name="Subject_List")
            ...
            print("Error: 'general_info.xlsx' not found. Make sure the file exists or that the path to the dataset is correctly set.")
            return None
    ...
    def load_ACC_data(self, subject = "S1", event = "morning"):
        ...
        try:
            ...
            data_path = f"{file_path}/subject_{subject[1:]}/{mapping[event]}/ACC.csv"
    ...
    def load_BVP_data(self, subject = "S1", event = "morning"):
        ...
        try:
            # Try to create the path to the requested data
            data_path = f"{file_path}/subject_{subject[1:]}/{mapping[event]}/BVP.csv"
            # Load the requested data to a Pandas DataFrame if the path exists
            if os.path.exists(data_path):
    ...
    def load_EDA_data(self, subject = "S1", event = "morning"):
        ...
        try:
            # Try to create the path to the requested data
            data_path = f"{file_path}/subject_{subject[1:]}/{mapping[event]}/EDA.csv"
            # Load the requested data to a Pandas DataFrame if the path exists
            if os.path.exists(data_path):
    ...
    def load_EEG_data(self, subject = "S1", event = "morning"):
        ...
        try:
            # Try to create the path to the requested data
            data_path = f"{file_path}/subject_{subject[1:]}/{mapping[event]}/EEG.csv"
            # Load the requested data to a Pandas DataFrame if the path exists
            if os.path.exists(data_path):
    ...
    def load_IBI_data(self, subject = "S1", event = "morning"):
        ...
        try:
            # Try to create the path to the requested data
            data_path = f"{file_path}/subject_{subject[1:]}/{mapping[event]}/IBI.csv"
            # Load the requested data to a Pandas DataFrame if the path exists
            if os.path.exists(data_path):
    ...
    def load_HR_data(self, subject = "S1", event = "morning"):
        ...
        try:
            # Try to create the path to the requested data
            data_path = f"{file_path}/subject_{subject[1:]}/{mapping[event]}/HR.csv"
            # Load the requested data to a Pandas DataFrame if the path exists
            if os.path.exists(data_path):
    ...
    def load_temperature_data(self, subject = "S1", event = "morning"):
        ...
        try:
            # Try to create the path to the requested data
            data_path = f"{file_path}/subject_{subject[1:]}/{mapping[event]}/TEMP.csv"
            # Load the requested data to a Pandas DataFrame if the path exists
            if os.path.exists(data_path):
